    ...
    <section class="text-black body-font lg:pt-20">
          ...
          <div class="container px-5 py-10 mx-auto">
            <div class="flex flex-wrap -m-4 text-center">
              ...
              <div class="p-4 sm:w-1/3 w-1/2">
                ...
                <p class="leading-relaxed">Races</p>
              </div>
              <div class="p-4 sm:w-1/3 w-1/2">
          ...
          <div class="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pr-12 lg:text-left text-center">
            <div class="flex flex-col mb-10 lg:items-start items-center">
              <div class="flex-grow">
                ...
                <p class="leading-relaxed text-lg mb-4">
                  Win Racing was born 3 years ago, with the mission statement to provide an affordable route into outdoor karting, to give the 'dad and lads' an opportunity to rade against the big teams, to get the big results, but without the big price tag!
                </p>
                <p class="leading-relaxed text-lg mb-4">
                ...
                <div class="p-4 lg:w-1/4 md:w-1/2">
                  <div class="h-full flex flex-col items-center text-center">
                    <div class="w-full">
                      ...
                      <h3 class="text-gray-500 mb-3">Parent</h3>
                      <p class="mb-4">
                ...
                <div class="p-4 lg:w-1/4 md:w-1/2">
                  <div class="h-full flex flex-col items-center text-center">
                    <div class="w-full">
                      ...
                      <h3 class="text-gray-500 mb-3">Top Gear</h3>
                      <p class="mb-4">
                ...
                <div class="p-4 lg:w-1/4 md:w-1/2">
                  <div class="h-full flex flex-col items-center text-center">
                    <div class="w-full">
                      ...
                      <h3 class="text-gray-500 mb-3">Racing Driver</h3>
                      <p class="mb-4">
      ...
      <section class="text-gray-600 body-font">
        <div class="container px-5 mx-auto">
          <form>
            <div class="mb-6">
              {/* <label for="email" class="block mb-2 text-lg font-medium text-gray-600 dark:text-white">Your name</label> */}
              <label for="email" class="block mb-2 text-lg text-gray-600 dark:text-white">Your name</label>
              <input type="email" id="email" class="bg-gray-50 border border-gray-600 text-gray-600 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Full Name" required />
            </div>
            <div class="mb-6">
              <label for="email" class="block mb-2 text-lg text-gray-600 dark:text-white">Your email</label>
              <input type="email" id="email" class="bg-gray-50 border border-gray-600 text-gray-600 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="name@email.com" required />
            </div>
            <div class="mb-6">
              <label for="message" class="block mb-2 text-lg text-gray-600 dark:text-white">Your message</label>
              <textarea id="message" rows="4" class="block p-2.5 w-full text-lg text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Leave a comment..."></textarea>
            </div>
